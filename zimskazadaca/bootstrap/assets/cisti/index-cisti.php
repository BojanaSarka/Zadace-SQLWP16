    ...
    <body>
        ...
        <nav class="navigation-main">
            ...
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><img class="img-responsive" src="../assets/img/Petclinic.png" alt="" /></a>
                </div>
                <!-- /NAVIGATION HEADER -->
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    ...
                    <ul class="navigation-items nav navbar-nav navbar-right">
                        <li class="current"><a href="#intro">Početna</a></li>
                        <li><a href="#about">O nama</a></li>
                        <li><a href="#service">Usluge</a></li>
                        <li><a href="#contact">Kontakt</a></li>
                        <li><a href="#work">Galerija</a></li>
        ...
        <section id="intro">
            ...
            <div class="container-mid text-center">
                ...
                <div class="animation-container animation-fade-down" data-animation-delay="0">
                    <h1>Dobro došli u <br>Pet clinic</h1>
                </div>
                <!-- /ANIMATION CONTAINER -->
        ...
        <section id="about" class="white">
            ...
            <div class="container-fluid text-center">
                <h3 class="headline scroll-animated-from-bottom">Mi smo sve što  treba Vašem kućnom ljubimcu</h3>
                <p class="subline scroll-animated-from-bottom">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas congue augue eget blandit congue. Aliquam nec mattis elit. Mauris a leo erat. Proin vulputate tincidunt diam nec auctor. Pellentesque sit amet lobortis tellus. Pellentesque congue tortor ut elementum dapibus. Suspendisse potenti.</p>
 
                <!-- COLUMN -->
                <div class="col-sm-4 text-left about-item scroll-animated-from-bottom">
                    <img class="img-responsive" src="../assets/img/about/about-1.png" alt="image">
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas congue augue eget blandit congue.</p>
                </div>
                <!-- /COLUMN -->

                <!-- COLUMN -->
                <div class="col-sm-4 text-left about-item scroll-animated-from-bottom">
                    <img class="img-responsive" src="../assets/img/about/about-2.png" alt="image">
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas congue augue eget blandit congue.</p>
                </div>
                <!-- /COLUMN -->
                ...
                <!-- COLUMN -->
                <div class="col-sm-4 text-left about-item scroll-animated-from-bottom">
                    <img class="img-responsive" src="../assets/img/about/about-3.png" alt="image">
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas congue augue eget blandit congue.</p>
                </div>
                <!-- /COLUMN -->
            </div>
        ...
        <section id="service">
            ...
            <!-- CONTAINER FLUID -->
            <div class="container-fluid text-center">
                <h3 class="headline scroll-animated-from-bottom">Sve što je potrebno za zdrav i kvalitetan život Vašeg kućnog ljubimca.</h3>
        ...
        <section id="work" class="white">
            <!-- CONTAINER FLUID -->
            <div class="container-fluid text-center">
                <h3 class="headline scroll-animated-from-bottom">Naši dugogodišnji klijenti</h3>
                <!-- WORK CAROUSEL -->
                <div class="work-carousel owl-carousel scroll-animated-from-bottom">
                    <!-- ITEM -->
                    <div class="item">
                        <div class="bg-image" style="background-image: url(../assets/img/work/one.jpg)"></div>
                        <!-- INFO -->
                        ...
                        <div class="lightbox-wrapper">
                            ...
                            <div id="item-1-lightbox" class="work-lightbox">
                                <img class="img-responsive" src="../assets/img/work/one.jpg" alt="image">
                                
                                <!-- DESCRIPTION -->
                                <div class="description">
                                    <p class="subline">Mačke</p>
                    ...
                    <!-- ITEM -->
                    <div class="item">
                        <div class="bg-image" style="background-image: url(../assets/img/work/two.jpg)"></div>
                        ...
                        <div class="lightbox-wrapper">
                            ...
                            <div id="item-2-lightbox" class="work-lightbox">
                                <img class="img-responsive" src="../assets/img/work/two.jpg" alt="image">
                                
                                <!-- DESCRIPTION -->
                                <div class="description">
                                    <p class="subline">Mačke i psi</p>
                    ...
                    <!-- ITEM -->
                    <div class="item">
                        <div class="bg-image" style="background-image: url(../assets/img/work/three.jpg)"></div>
                        ...
                        <div class="lightbox-wrapper">
                            ...
                            <div id="item-3-lightbox" class="work-lightbox">
                                <img class="img-responsive" src="../assets/img/work/three.jpg" alt="image">
                    ...
                    <!-- ITEM -->
                    <div class="item">
                        <div class="bg-image" style="background-image: url(../assets/img/work/four.jpg)"></div>
                        ...
                        <div class="lightbox-wrapper">
                            ...
                            <div id="item-4-lightbox" class="work-lightbox">
                                <img class="img-responsive" src="../assets/img/work/four.jpg" alt="image">
                                
                                <!-- DESCRIPTION -->
                                <div class="description">
                                    <h3>Bull Terrier mini</h3>
                    ...
                    <!-- ITEM -->
                    <div class="item">
                        <div class="bg-image" style="background-image: url(../assets/img/work/five.png)"></div>
                        ...
                        <div class="lightbox-wrapper">
                            ...
                            <div id="item-5-lightbox" class="work-lightbox">
                                <img class="img-responsive" src="../assets/img/work/five.png" alt="image">
                                
                                <!-- DESCRIPTION -->
                                <div class="description">
                                    <p class="subline">Bull Terrier</p>
        ...
        <section id="clients">
            ...
            <div class="container-fluid text-center">
                ...
                <h3 class="headline scroll-animated-from-bottom">Mišljenja naših korisnika</h3>
                ...
                <div class="client-feedback">
                    ...
                    <div class="client-feedback-item row">
                        ...
                        <div class="col-sm-3 text-left scroll-animated-from-bottom">
                            ...
                            <img class="img-responsive logo" src="../assets/img/Petclinic.png" alt="image">
        ...
        <section id="contact" class="white">
            ...
            <!-- CONTAINER FLUID -->
            <div class="container-fluid text-center">
                <h3 class="headline scroll-animated-from-bottom">Kontaktirajte nas</h3>
                <!-- CONTACT LIST -->
                <ul class="contact-list">
                    ...
                    <li class="contact-list-item scroll-animated-from-bottom">
                        ...
                        <!-- /CONTACT TYPE -->
                        <h6>Trg Ante Starčevića 1, Osijek</h6>
                    </li>
                    <!-- /CONTACT LIST ITEM -->
                </ul>
                <!-- CONTACT LIST -->
